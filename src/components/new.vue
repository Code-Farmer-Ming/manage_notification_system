    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" v-bind:class="{active: tab=='by_region'}">
            <a href="#" v-on:click.prevent="tab = 'by_region'">By Region</a>
          </li>
          <li role="presentation" v-bind:class="{active: tab=='by_member'}">
            <a href="#" v-on:click.prevent="tab = 'by_member'">By Member</a>
          </li>
        </ul>
        <br>
